...
class  Tx_Solr_ModuleAdmin extends \TYPO3\CMS\Backend\Module\BaseScriptClass {
	...
	public function main() {
		...
		if ($rootPageId) {
			$this->site              = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(\Tx_Solr_Site::class, $rootPageId);
			$this->connectionManager = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(\Tx_Solr_ConnectionManager::class);
		}
	...
	protected function renderIndexQueueInitializationSelector() {
		$selector = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(\Tx_Solr_backend_IndexingConfigurationSelectorField::class, $this->site);
	...
	protected function initializeIndexQueue() {
		...
		$itemIndexQueue = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(\Tx_Solr_IndexQueue_Queue::class);
...
// Make instance:
$SOBE = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(\Tx_Solr_ModuleAdmin::class);
$SOBE->init();
