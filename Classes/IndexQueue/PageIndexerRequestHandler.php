...
class Tx_Solr_IndexQueue_PageIndexerRequestHandler implements \TYPO3\CMS\Core\SingletonInterface {
	...
	public function __construct() {
		$this->dispatcher = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(\Tx_Solr_IndexQueue_FrontendHelper_Dispatcher::class);

		$this->request    = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(\Tx_Solr_IndexQueue_PageIndexerRequest::class, $_SERVER['HTTP_X_TX_SOLR_IQ']
		);
		$this->response   = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(\Tx_Solr_IndexQueue_PageIndexerResponse::class);
