...
class Tx_Solr_Facet_HierarchicalFacetRenderer extends Tx_Solr_Facet_AbstractFacetRenderer {
	...
	protected function renderFacetOptions() {
		...
		$filterEncoder = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(\Tx_Solr_Query_FilterEncoder_Hierarchy::class);
		...
		foreach ($facetOptions as $facetOptionValue => $facetOptionResultCount) {
			$facetOption = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(\Tx_Solr_Facet_FacetOption::class,
				$this->facetName,
				$facetOptionValue,
			...
			$facetLinkBuilder = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(\Tx_Solr_Facet_LinkBuilder::class, $this->search->getQuery(), $this->facetName, $facetOption);
