...
class Tx_Solr_ModIndex_IndexInspectorRemoteController {
	...
	protected function initializeSearch() {
		...
		$this->search = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(\Tx_Solr_Search::class, $solrConnection);
	}
	...
	protected function getIndexDocuments() {
		$query = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(\Tx_Solr_Query::class, '');
